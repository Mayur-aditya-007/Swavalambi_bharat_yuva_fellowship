...
export const metadata = {
  title: "Daily Report - Swavalambi Bharat Yuva Fellowship",
  description: "Submit your daily report for the Swavalambi Bharat Yuva Fellowship",
};
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        <div className="text-center space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-zinc-700 dark:text-zinc-300">
            {dict.dailyReport.pageSubtitle}
          </p>
        </div>
        
        <div className="bg-transparent">
          <DailyReportForm dict={dict} />
        </div>
      </div>
    </div>
  );
